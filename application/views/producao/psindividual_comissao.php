                ...
                <button type="button" class="btn bg-indigo waves-effect" data-toggle="collapse" data-target="#div-filtros" aria-expanded="true">
                 ...
                 <div class="collapse"  id="div-filtros" >
                    <div class="well">
                        ...
                        <form method="post" id="form-filters" name="form-filters" action="<?php echo site_url('producao/psindividual/comissao') ?>">
    ...
    <div class="col-md-6">
        <div class="input-group input-group-lg">
            <span class="input-group-addon">
                <input value="individual" type="radio" class="with-gap radio-col-indigo"  name="rel_tipo" id="rel_tipo-individual">
                <label for="rel_tipo-individual">Individual</label>
            </span>

             <span class="input-group-addon">
            <input value="adesao" checked type="radio" class="with-gap radio-col-indigo" name="rel_tipo" id="rel_tipo-adesao">
            <label for="rel_tipo-adesao">Adesão</label>
        </span>
        </div>
    </div>
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <?php if( !is_null( $tipo_relatorio ) && $tipo_relatorio == 'comissao_individual' ):  ?>
