...
$autoload['libraries'] = array('database', 'view', 'session','form_validation', 'breadcrumbs');
...
$autoload['helper'] = array('html', 'resource', 'url', 'form', 'clickables', 'messages','micspecial','formatm');
