...
|
*/
$config['encryption_key'] = 'bMq2drJIvjcTobcrFuJFpc';
...
$config['sess_cookie_name']		= 'ck_vrs';
...
|
*/
$config['global_xss_filtering'] = FALSE;//deixarei ativo por enquanto, se tivermos problemas desativamos
