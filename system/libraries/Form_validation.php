...
class CI_Form_validation {
	 ...
	 * @return	bool
	 */
	public function alpha_pt_br($str)
	{
		return (bool) preg_match('/^[A-ZÁÉÍÓÚÀÈÌÒÙÂÊÎÔÛÃÕÜÇ]+$/i', $str);
	}

	// --------------------------------------------------------------------

	/**
	 * Alpha pt br with spaces
	 *
	 * @param	string
	 * @return	bool
	 */
	public function alpha_pt_br_spaces($str)
	{
		return (bool) preg_match('/^[A-Z ÁÉÍÓÚÀÈÌÒÙÂÊÎÔÛÃÕÜÇ]+$/i', $str);
	}
	 ...
	 * @return	bool
	 */
	public function alphanumeric_pt_br($str)
	{
		return (bool) preg_match('/^[0-9A-ZÁÉÍÓÚÀÈÌÒÙÂÊÎÔÛÃÕÜÇ]+$/i', $str);
	}

	// --------------------------------------------------------------------

	/**
	 * Alphanumeric pt br with spaces
	 *
	 * @param	string
	 * @return	bool
	 */
	public function alphanumeric_pt_br_spaces($str)
	{
		return (bool) preg_match('/^[0-9A-Z ÁÉÍÓÚÀÈÌÒÙÂÊÎÔÛÃÕÜÇáéíóúàèìòùâêîôûãõüç]+$/i', $str);
	}
	 ...
	 * @return	bool
	 */
	public function alpha_numeric_url($str)
	{
    ...
    public function valid_cpf($str)
    {
        ...
        if(strlen($str) != 11 || preg_match('/^([0-9])\1+$/', $str))
        {
            return false;
        }

        // 9 primeiros digitos do cpf
        $digit = substr($str, 0, 9);
        ...
        return $digit[9] == ((int)$str[9]) && $digit[10] == ((int)$str[10]);
    }
    ...
    public function valid_cep($str)
    {
        ...
        $url = 'http://republicavirtual.com.br/web_cep.php?cep='.urlencode($str).'&formato=query_string';
        $ch = curl_init();
